...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-neutral sans-serif">
      ...
      <!-- Footer -->
      <footer class="flex flex-col items-center bg-primary text-center text-surface text-slate pt-9">
        <img src="/asset/brand.svg" alt="" class="h-auto w-96"/>
      <div class="container pt-9">
        <div class="flex flex-wrap justify-center items-center">
         
          <div class="flex flex-col items-center mb-6 space-y-4 px-20">
            <p class="text-xl font-semibold text-surface text-slate">
              Ikuti Kami :
            </p>
            ...
            <div class="flex justify-center space-x-2">
              <a
                href="#!"
                type="button"
                class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-secondary focus:outline-none focus:ring-0 text-slate hover:bg-secondary-900"
          ...
          <a
            ...
            <p class="text-lg text-surface text-slate">
            {{ $appset->address }}
            </p>
          </div>
    
          <div class="mb-6 w-full md:w-auto px-20 items-center flex justify-center">
            <iframe
              title="Google Maps"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.5973740742725!2d123.07952357581861!3d0.6029848635194317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32792b5377da427b%3A0xeee2a3b90b3ff61f!2sNokturnal_sp!5e0!3m2!1sid!2sid!4v1730261089336!5m2!1sid!2sid"
              class="rounded-md shadow-lg desktop:w-[35rem] h-64 hp:w-72"
              allowFullScreen=""
              loading="lazy"
